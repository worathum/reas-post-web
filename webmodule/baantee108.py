...
class baantee108():
    ...
    def register_user(self, postdata):
        ...
        response = httprequestObj.http_post('http://www.baantee108.com/member-register.php', data = data1, headers = headers)
        ...
        if data['email'] == "":
            ...
            try:
                res = httprequestObj.http_post('http://www.baantee108.com/p-member-register.php', data = data, headers = headers)
    ...
    def test_login(self, postdata):
        ...
        if data['email'] == "":
            ...
            try:
                response = httprequestObj.http_post('http://www.baantee108.com/login.php', data = data, headers = headers)
                ...
                if 'ขออภัยครับ ท่านกรอก Email และ/หรือ Password ไม่ถูกต้องครับ' in response.text:
                    ...
                    res = httprequestObj.http_get('http://www.baantee108.com/member/index.php')
                    #print(res.text)
    ...
    def create_post(self,postdata):
        ...
        if (login["success"] == "true"):
            ...
            find_province = httprequestObj.http_get('http://www.baantee108.com/member/post-property.php', headers = headers).text
            ...
            respo = httprequestObj.http_get('http://www.baantee108.com/member/post-property.php', headers = headers)
        ...
        if(login['success'] == "true"):
            ...
            for i in range(1,max_p+1):
                ...
                if req_post_id in all_post_ids:
                    ...
                    delete_post = httprequestObj.http_post('http://www.baantee108.com/member/manage-property-not-sale.php', data = data, headers = headers)
