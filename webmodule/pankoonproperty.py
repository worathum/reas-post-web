...
class pankoonproperty():
    ...
    def create_post(self,postdata):
        ...
        if (login["success"] == "true"):
            ...
            post_url = str('http://www.pankoonproperty.com/property-'+post_id+'/.html')
    ...
    def search_post(self,postdata):
        ...
        if (login['success'] == 'true'):
            ...
            for abc in xyz.find_all('tr')[1:-1]:
                #print(str(abc.find('a', attrs = {'target':'_blank'})['title']))
                
                if req_post_title == str(abc.find('a', attrs = {'target':'_blank'})['title']):
                    post_id = str(abc.input['value'])
                    post_url = str('http://www.pankoonproperty.com/property-'+str(post_id)+'/.html')
                    post_found = "true"
