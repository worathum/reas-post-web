...
class teedindd():
    ...
    def boost_post(self, postdata):
        ...
        r=self.httprequestObj.http_post(posturl,data={'DunDate':'1'})
        time_end = datetime.datetime.utcnow()
        return {
            "websitename": "teedindd",
            "success": "true",
    ...
    def editpost(self, postdata):
        ...
        if success == "true":
            ...
            r = self.httprequestObj.http_get(url_post)
            soup = BeautifulSoup(r.content, features = self.parser)
            ...
            r = self.httprequestObj.http_post(url_district, data={'pid': postdata['addr_pros'].split(',')[0], 'name': postdata['addr_pros'].split(',')[1]})
            ...
            url_district = 'https://www.teedindd.com/admin/step-process.php'
            r = self.httprequestObj.http_post(url_district, data={
    ...
    def edit_post(self,postdata):
        ...
        if j['success'] == "true":
            for i,id in enumerate(prev_img):
                r = self.httprequestObj.http_get('https://www.teedindd.com/admin/properties-process.php?imgDelete=' + str(id))
                print(i,r.text)
    ...
    def delete_post(self, postdata):
        ...
        if success == "true":
            r = self.httprequestObj.http_get('https://www.teedindd.com/post.php?pd=' + str(postdata['post_id']))
            soup = BeautifulSoup(r.content, features = self.parser)
            var = soup.find('input',attrs={'id':'ti'})
            ...
            r = self.httprequestObj.http_post('https://www.teedindd.com/admin/properties-process.php', data=datapost)
            data = r.text
            if data == '':
                success = "false"
