...
class bannforsale():
    ...
    def register_user(self,postdata):
        self.httprequestObj.http_get("https://bannforsale.com/front/logout")
        ...
        if self.httprequestObj.http_get(checkmailurl).json() == 'no':
        ...
        r = self.httprequestObj.http_get("https://bannforsale.com/registers")
        ...
        self.httprequestObj.http_post('https://bannforsale.com/register/regis', data=data)
    ...
    def test_login(self,postdata):
        ...
        response = self.httprequestObj.http_post('https://bannforsale.com/front/login', data=data)
    ...
    def create_post(self,postdata):
        ...
        if test_login['success'] == "true":
            ...
            r = self.httprequestObj.http_get("https://bannforsale.com/post")
            soup = BeautifulSoup(r.content,'lxml')
            token = soup.find('input',attrs={'name':'_token'}).attrs.get('value')
            ...
            response = self.httprequestObj.http_post('https://bannforsale.com/product/test/sendimg', data={}, files=theimgs)
            #print(response.text)


            response = self.httprequestObj.http_post('https://bannforsale.com/member/addproduct', data=data, files=files)
            #print(response.status_code)

            r = self.httprequestObj.http_get("https://bannforsale.com/view-post")
            soup = BeautifulSoup(r.content, 'lxml')
    ...
    def edit_post(self,postdata):
        ...
        if test_login['success'] == "true":
            ...
            response = self.httprequestObj.http_post('https://bannforsale.com/member/editproduct', data=data, files=files)
    ...
    def search_post(self,postdata):
        ...
        if test_login['success'] == "true":
            ...
            while(flag):
                ...
                if found == 0:
                    r = self.httprequestObj.http_get('https://bannforsale.com/view-post?page={}'.format(x))
                    x = x+1
