...
class baansecondhand():
    ...
    def register_user(self, postdata):
        ...
        r = self.httprequestObj.http_get(self.site_name+'/register.php')

        captcha_img = self.httprequestObj.http_get(self.site_name+'/images/cap.php', stream=True)
        if captcha_img.status_code==200:
            ...
            if g_response[0]==1:
                ...
                response = self.httprequestObj.http_post(self.site_name+'/register.php', data=datapost)    
    ...
    def search_post(self, postdata):
        ...
        if success == "true":
            ...
            response = self.httprequestObj.http_get('https://www.baansecondhand.com/mypage.php')
            if response.status_code==200:
        ...
        if success=="true":
            ...
            if r.status_code==200:
                ...
                if flag:
                    ...
                    response = self.httprequestObj.http_get(delete_url)
                    if response.status_code==200:
        ...
        if success=="true":
            ...
            if r.status_code==200:
                ...
                if flag:
                    ...
                    response = self.httprequestObj.http_get(update_url)
                    if response.status_code==200:
