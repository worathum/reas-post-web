...
class baan2day():
    ...
    def register_user(self, postdata):
        ...
        response = self.httprequestObj.http_post(self.site_name+'/member_register_aed.php?typ=add', data=datapost)
    ...
    def test_login(self, postdata):
        ...
        response = self.httprequestObj.http_post(self.site_name+'/login_aed.php', data=datapost)
    ...
    def edit_post(self, postdata):
        ...
        if success=="true":
            ...
            if len(postdata['post_images'])>0:
                r = self.httprequestObj.http_get(self.site_name+'/member_property_add.php?id='+postdata['post_id'])
                soup = BeautifulSoup(r.text, features=self.parser)
            ...
            response = self.httprequestObj.http_post(self.site_name+'/member_property_aed.php?typ=edit&id='+str(postdata['post_id']), data=datapost, files=files)
            success = "false"
            if response.status_code==200:
                if "window.location.href='member_property_list.php" in response.text:
                    success = "true"
    ...
    def delete_post(self, postdata):
        ...
        if success=="true":
            response = self.httprequestObj.http_get(self.site_name+'/member_property_aed.php?typ=delete&id='+postdata['post_id'])
            success = "false"
            if response.status_code==200:
    ...
    def search_post(self, postdata):
        ...
        if success == "true":
            ...
            # }
            # response = self.httprequestObj.http_get(self.site_name+'/member_property_list.php?&nowpage='+str(page))
            response = self.httprequestObj.http_get(self.site_name+'/member_property_list.php')
            if response.status_code==200:
                soup = BeautifulSoup(response.text, features=self.parser)
    ...
    def boost_post(self, postdata):
        ...
        if success=="true":
            ...
            response = self.httprequestObj.http_get(self.site_name+'/member_property_aed.php?typ=uptop&id='+postdata['post_id'])
            if response.status_code==200:
                if "window.location.href='member_property_list.php" in response.text:
                    success = "true"
