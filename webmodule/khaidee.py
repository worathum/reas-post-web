...
class khaidee():
    ...
    def create_post(self,postdata):
        ...
        if (login["success"] == "true"):
            ...
            post_id_temp = str((abc['content'].split('/'))[1])
            #print(post_id)

            post_id = post_id_temp[4:]

            post_url = str('https://www.khaidee.co.th/prd-'+post_id+'/.html')
    ...
    def delete_post(self,postdata):
        ...
        return {
            ...
            "end_time": str(end_time),
            "usage_time": str(end_time - start_time),
            "detail": "Problem with delete operation on the site",
            "ds_id": str(postdata['ds_id']),
            "post_id": str(postdata['post_id']),
            "log_id": postdata['log_id']
        }
    ...
    def search_post(self,postdata):
        ...
        if (login['success'] == 'true'):
            ...
            for abc in xyz.find_all('tr')[1:-1]:
                ...
                if req_post_title == str(abc.find('a', attrs = {'target':'_blank'})['title']):
                    ...
                    post_url = str('https://www.khaidee.co.th/prd-'+str(post_id)+'/.html')
                    post_found = "true"
        ...
        return {
            ...
            "post_view": "No post views shown on the site",
