...
class buyzaa():
    ...
    def register_user(self, postdata):
        ...
        r = self.httprequestObj.http_get('http://www.buyzaa.com/register.php')
        print(r.url)
        print(r.status_code)
        ...
        r = self.httprequestObj.http_post('http://www.buyzaa.com/lib/checkuser.php', data=datapost)
        # print(r.url)
        # print(r.status_code)
        data = r.text

        r = self.httprequestObj.http_post('http://www.buyzaa.com/register.php', data=datapost)
        # print(r.url)
        # print(r.status_code)
        data = r.text
    ...
    def test_login(self, postdata):
        r = self.httprequestObj.http_get('http://www.buyzaa.com/logout.php')
        self.print_debug('function [' + sys._getframe().f_code.co_name + ']')
        time_start = datetime.datetime.utcnow()
        ...
        r = self.httprequestObj.http_get('http://www.buyzaa.com/member.php')
        # print(r.url)
        # print(r.status_code)
        ...
        r = self.httprequestObj.http_post('http://www.buyzaa.com/member.php', data=datapost)
        # print(r.url)
        # print(r.status_code)
        data = r.text
    ...
    def create_post(self, postdata):
        ...
        if success:
            ...
            r = self.httprequestObj.http_get('http://www.buyzaa.com/post-add.php')
            # print(r.url)
            # print(r.status_code)
            ...
            r = self.httprequestObj.http_get('http://www.buyzaa.com/lib/district.php', params={'province': province_id})
            # print(r.url)
            # print(r.status_code)
            ...
            r = self.httprequestObj.http_post('http://www.buyzaa.com/lib/checkpost.php', data=datapost)
            # print(r.url)
            # print(r.status_code)
            ...
            r = self.httprequestObj.http_post('http://www.buyzaa.com/post-add.php', data={}, files=datapost)
            # print(r.url)
            # print(r.status_code)
    ...
    def edit_post(self, postdata):
        ...
        if success:
            ...
            """while True:
                ...
                if page > tot_pages:
                    break
                r = self.httprequestObj.http_get('http://www.buyzaa.com/manage-post.php', params={'page': str(page)})
                # print(r.url)
                # print(r.status_code)
            ...
            if post_found:
                ...
                r = self.httprequestObj.http_get('http://www.buyzaa.com/post-edit.php', params={'id': postdata['post_id']})
                # print(r.url)
                # print(r.status_code)
                ...
                for i in range(6):
                    ...
                    r = self.httprequestObj.http_get('http://www.buyzaa.com/post-edit.php', params=params)
                    # print(r.url)
                    # print(r.status_code)
                ...
                r = self.httprequestObj.http_post('http://www.buyzaa.com/post-edit.php', params=params, data={},
                                             files=datapost)
                # print(r.url)
                # print(r.status_code)
    ...
    def boost_post(self, postdata):
        ...
        if success:
            ...
            try:
                r = self.httprequestObj.http_get('http://www.buyzaa.com/manage-post.php', params={'update': post_id})
                # print(r.url)
                # print(r.status_code)
    ...
    def delete_post(self, postdata):
        ...
        if success:
            ...
            if post_found:
                r = self.httprequestObj.http_get('http://www.buyzaa.com/manage-post.php', params={'delete': post_id})
                # print(r.url)
                # print(r.status_code)
